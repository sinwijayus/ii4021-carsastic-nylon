class MataKuliah < ApplicationRecord
  ...
  validates :pass_rate, numericality: { greater_than_or_equal_to: 0, less_than_or_equal_to: 0 }
  validates :trend_rate, numericality: { greater_than_or_equal_to: 0, less_than_or_equal_to: 0 }
  def kode_matkul
